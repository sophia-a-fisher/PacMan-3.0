...
/**
 * represents a pacman character in the maze
 */
public class Player extends Sprite2D implements InputConstants
{
	...
	public ArrayList<String> healthBar;
	...
	/**
	 *stores information for a key press instance including time when pressed and the actual key value
	 */
	...
	/**
	 * creates a sprite object for the player and initializes class members
	...
	public Player(String fileName, Vector3f position, Vector3f scale, Maze myMaze) 
	{
		...
		healthBar = new ArrayList<String>();
	...
	/**
	 * finds the player's coordinate position
	...
	/**
	 * finds the player's column position
	...
	/**
	 * finds the player's row position
	...
	/**
	 * finds a column's center's x pixel position
	...
	/**
	 * finds a row's center's y pixel position
	...
	/**
	 * finds if the player's center position is to the right of the column's center
	...
	/**
	 * finds if the player's center position is above the row's center
	...
	/**
	 * finds if the player has reached the target position
	...
	/**
	 * finds if the player's x has reached the target x
	...
	/**
	 * finds if the player's y has reached the target y
	...
	/**
	 * finds if the player is very near the center of the column
	...
	/**'finds if the player is very near the center of the row
