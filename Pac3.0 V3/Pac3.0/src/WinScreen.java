...
/**
 * This represents the screen that will be projected when the player wins
 */
public class WinScreen  extends KGScene implements InputConstants, TimerListener
{
	...
	/**
	 * initializes the win screen by adding an image and setting a timer for projection
	 */
	@Override
	public void init() 
	{
		// TODO Auto-generated method stub
		KGE.addGUIImage("Winner").setPosition(new Vector3f(0, 0.17f, 0f));
		KGE.showCursor();
